...
export class PrologueWIP extends Component {
  static displayName = PrologueWIP.name;
        ...
        {!this.state.isSolved
          ? <div>
            ...
            <div className="the-buttons">
              <button>boat</button>
              <button>birb</button>
              <button>sandcastle</button>
              <button className="selected">bucket & spade</button>
              <button>doggo</button>
              <button>sandwich</button>
              <button>umbrella</button>
              <button>sun</button>
              <button className="selected">plane</button>
            </div>
          </div> : null}
      </div>
    );
